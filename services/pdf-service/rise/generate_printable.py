...
def generate_printable_cert(base_pdf_path: str, output_pdf_path: str, values: Dict[str, str], template_type: str = "standard") -> None:
    ...
    standard_coords = {
        ...
        "Scope": {
            "short": fitz.Rect(87.9, 400, 580, 475),           # Adjusted: moved down
            "long": fitz.Rect(87.9, 387, 580, 486)             # Adjusted: moved down
        },
    ...
    large_coords = {
        ...
        "Scope": fitz.Rect(85, 366, 577, 536),                 # Adjusted: moved down
        "certification_code": fitz.Rect(253, 757, 285, 762)  # ✅ UPDATED: Certification code coordinates
    }
    ...
    logo_coords = {
        ...
        "Scope": {
            "short": fitz.Rect(87.9, 440, 580, 515),           # Adjusted: moved down
            "long": fitz.Rect(87.9, 427, 580, 526)             # Adjusted: moved down
        },
        "certification_code": fitz.Rect(253, 757, 285, 762)  # ✅ UPDATED: Certification code coordinates
    }
            ...
            try:
                ...
                if cert_code:
                    ...
                    if accreditation == "no":
                        ...
                        print(f"🔍 [PRINTABLE] Non-accredited certificate - using right position")
                    else:
                        # Accredited: Use original position
                        code_rect = coords["certification_code"]  # Original: (253, 757, 285, 762)
                        print(f"🔍 [PRINTABLE] Accredited certificate - using standard position")
